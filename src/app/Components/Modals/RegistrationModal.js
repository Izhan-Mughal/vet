...
const RegistrationModal = () => {
    return (
        <>
            <div className="modal fade" id="registrationModal" tabIndex="-1" aria-labelledby="registrationModal" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body">
                            <div className='d-flex align-items-center justify-content-between'>
                                <h4 className="modal-title fw-500" id="registrationModal" style={{ fontWeight: 600 }}>Registrazione</h4>
                            ...
                            <div className='login-btn-modal'>
                                <button className='theme-btn-2 w-100' data-bs-toggle="modal" data-bs-target="#registraionFormModal" style={{ fontSize: '16px', padding: '6px', fontWeight: 500 }}>Continua con la mail</button>
                            </div>
